...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.greet.GreetEveryoneRequest,
      com.grpc.greet.GreetEveryoneResponse> getGreetEveryoneMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greetEveryone",
      requestType = com.grpc.greet.GreetEveryoneRequest.class,
      responseType = com.grpc.greet.GreetEveryoneResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.grpc.greet.GreetEveryoneRequest,
      com.grpc.greet.GreetEveryoneResponse> getGreetEveryoneMethod() {
    io.grpc.MethodDescriptor<com.grpc.greet.GreetEveryoneRequest, com.grpc.greet.GreetEveryoneResponse> getGreetEveryoneMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetEveryoneMethod = GreetServiceGrpc.getGreetEveryoneMethod) == null) {
          GreetServiceGrpc.getGreetEveryoneMethod = getGreetEveryoneMethod = 
              io.grpc.MethodDescriptor.<com.grpc.greet.GreetEveryoneRequest, com.grpc.greet.GreetEveryoneResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "GreetService", "greetEveryone"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.greet.GreetEveryoneRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.greet.GreetEveryoneResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.grpc.greet.GreetEveryoneRequest> greetEveryone(
        io.grpc.stub.StreamObserver<com.grpc.greet.GreetEveryoneResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.grpc.greet.GreetEveryoneRequest,
                com.grpc.greet.GreetEveryoneResponse>(
